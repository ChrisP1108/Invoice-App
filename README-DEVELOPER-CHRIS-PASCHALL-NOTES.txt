Developer LinkedIn Profile: https://www.linkedin.com/in/christopher-paschall/
Notes From The Developer - Chris Paschall
...
The command for it in gitbash is: json-server -H 0.0.0.0 --watch db.json -p 5000 -d 1000.  If you choose to git clone my code, you can simply 
type npm run server as I have it configured in the scripts of the package.json file.